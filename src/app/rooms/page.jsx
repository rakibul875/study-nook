...
//       <div className="bg-white shadow-md rounded-2xl md:rounded-full p-4 mb-8 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 border border-gray-100 max-w-5xl mx-auto">
...
//         <button type="submit" className="bg-[#006677] hover:bg-[#004d5a] text-white font-medium text-sm px-6 py-3 rounded-full transition-all duration-200 text-center w-full md:w-auto">
//           Apply Filters
//         </button>
//       </div>
