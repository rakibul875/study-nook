...
//   return (
//     <div className="min-h-screen w-full flex bg-gradient-to-tr from-[#eef2f3] to-[#e4efe9] p-4 font-sans">
//       <div className="mt-0 w-full max-w-2xl mx-auto bg-white rounded-[32px] p-6 shadow-xl border border-gray-100">
